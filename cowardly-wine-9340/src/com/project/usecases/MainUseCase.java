									...
									int number = sc.nextInt();
									 ...
									 switch(number){  
									    ...
									    case 5:{
											...
											System.out.println("Enter 'y' for assign another problem to engineer or 'n' to back ");
								        	String opt=sc.next();
								        	if(opt.equalsIgnoreCase("n")) {
								        		break;
								        	}
			    ...
			    case 2:
			        {
			    		...
			    		try {
			    			Engineer engineer= dao.loginEngineer(EngUserName, EngPassword);
			    	 		...
			    	 		System.out.println("Welcome to Engineer page :"+engineer.getEngName()+" You can use below services");
...
//											System.out.println("Problem status is : "+e.getPstatus());
									...
									System.out.println("Enter 'y' again see the list of assign problem or 'n' to other services ");
						        	String opt=sc.next();
						        	if(opt.equalsIgnoreCase("n")) {
						        		break;
						        	}
							    ...
							    case 2:{
							    	...
							    	while(true) {
							    	 System.out.println("Please enter your engid to update status");
										...
										System.out.println("Enter 'y' for update anothor status problem or 'n' to other services ");
							        	String opt=sc.next();
							        	if(opt.equalsIgnoreCase("n")) {
							        		break;
							        	}
...
//										problems.forEach(s -> System.out.println(s));
							    ...
							    case 4:{
									...
									System.out.println("Enter 'y' for change password of another engineer or 'n' to other services ");
						        	String opt=sc.next();
						        	if(opt.equalsIgnoreCase("n")) {
						        		break;
						        	}
							    ...
							    break;
							    //Default case statement  
							    default:System.out.println("Invalid Service of Engineer");  
							    }  
			    ...
			    case 3:{
			        ...
			        case 1: {
						...
						EmployeeDao dao9 = new EmployeeDaoImlp();
						
						try {
							Employee employee= dao9.loginEmployee(EmpUserName, EmpPassword);
						
					 		System.out.println("Welcome Employee :"+employee.getEmpName()+"your services as follows");
							...
							int empchoice2=sc.nextInt();
							 ...
							 switch(empchoice2){  
							    ...
							    case 2:{
									...
									System.out.println("Enter 'y' continue see the list of employee or 'n' to other services ");
						        	String opt=sc.next();
						        	if(opt.equalsIgnoreCase("n")) {
						        		break;
						        	}
							    ...
							    case 3:{
									...
									System.out.println("Enter 'y' continue change a password of anothor employee or 'n' to other services ");
						        	String opt=sc.next();
						        	if(opt.equalsIgnoreCase("n")) {
						        		break;
						        	}
							    ...
							    break;  
							    //Default case statement  
							    default:System.out.println("Service Not Found");  
							    }  
